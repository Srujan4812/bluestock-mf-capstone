"""
Weekly Performance HTML Email Report Generator.

Reads the latest cleaned CSVs and scorecard, compiles the key KPIs and risk metrics,
and renders a styled, responsive, dark-indigo themed HTML email report.
"""
...
<head>
    ...
    <title>Weekly Wealth Summary</title>
</head>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 40px auto; background-color: #0E1322; border: 1px solid #1E293B; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.4);">
        ...
        <tr>
            <td style="padding: 40px 30px; text-align: center; border-bottom: 1px solid #1E293B; background: linear-gradient(135deg, #4F46E5 0%, #10B981 100%); border-top-left-radius: 12px; border-top-right-radius: 12px;">
                <h1 style="margin: 0; font-size: 26px; font-weight: 800; color: #FFFFFF; letter-spacing: 2px; text-transform: uppercase;">MUTUAL FUND ANALYTICS</h1>
                <p style="margin: 5px 0 0 0; font-size: 12px; color: #E2E8F0; text-transform: uppercase; letter-spacing: 3px;">Weekly Wealth & Performance Summary</p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 30px;">
                <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #94A3B8;">
                    Hello, here is the automated weekly report for the Mutual Fund Analytics Platform. All daily return calculations, risk metrics, and scorecard rankings have been updated as of <b>{datetime.now().strftime('%Y-%m-%d')}</b>.
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 30px; text-align: center; border-top: 1px solid #1E293B; font-size: 11px; color: #64748B; background-color: #0E1322; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                <p style="margin: 0 0 10px 0;">This email summary is automatically generated by the ETL pipeline scheduler daemon.</p>
                <p style="margin: 0;">&copy; 2026 Mutual Fund Analytics Platform | Confidential Financial Data Report</p>
            </td>
        </tr>
    </table>
</body>
